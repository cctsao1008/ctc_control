...
*/
Message* BianNeng::trans2RTCMD(const char* Prescaler, const uint8_t Address, char Direction
...
*/
Message* BianNeng::trans2PRCMD(const char* Prescaler, const uint8_t Address, const char* TotalPulse
...
*/
Message* BianNeng::trans2SQCMD(const uint8_t Address, const char* Content)
{
	/*
	static uint8_t SQ_CMD[5] = { '\xB6', '\x00', '\x00', '\x00', '\xFE' };
	*/
	SQ_CMD = new uint8_t[5];
	SQ_CMD[0] = '\xB6';
	SQ_CMD[1] = '\x00';
	SQ_CMD[2] = '\x00';
	SQ_CMD[3] = '\x00';
